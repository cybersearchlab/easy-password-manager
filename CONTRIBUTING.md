...
7. **Open a Pull Request (PR)** on GitHub with a description of your changes.

    - When pushing your branch, GitHub will generate a link to create a pull request. You can access this link to open the PR and describe your modifications.
